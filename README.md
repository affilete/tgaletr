...
# Ваш Telegram User ID (получить от @userinfobot)
OWNER_USER_ID=your_telegram_user_id

# Chat ID для алертов (для групп: отрицательное число, например -5017751590)
...
**Важно для групп:**
- Chat ID должен быть отрицательным числом (например: `-5017751590`)
- Добавьте [@userinfobot](https://t.me/userinfobot) в группу чтобы получить Chat ID
- Бот должен быть добавлен в группу с правами отправки сообщений

📖 Подробная документация: см. [CONFIG_GUIDE.md](CONFIG_GUIDE.md)
